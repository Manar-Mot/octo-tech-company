...
const ApplyPartnerShipSection = () => {
  const t = useTranslations("partnershipSection.ApplyPartnerShipSection");
  ...
  return (
    <SectionContainer custom="flex flex-col lg:flex-row items-center justify-center lg:justify-between">
      ...
      <div className="flex flex-col items-center lg:items-start">
        ...
        <p className="mt-3 md:max-w-[520px] lg:text-[20px] md:text-[18px] text-[16px] text-paragraph text-center md:text-start">
          {t('description')}
        </p>
        <div className="mt-4">
          <ButtonComp
      ...
      <Image src={applyPartnership} alt="apply partnership" className="hidden lg:block ltr:rotate-180" />
    </SectionContainer>
  );
};
